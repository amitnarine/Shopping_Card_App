...
public class RecentlyPurchasedListActivity extends AppCompatActivity
    ...
    public static List<Item> jobLeadsLists;
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        jobLeadsLists = new ArrayList<Item>();
        ...
        myRef.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot snapshot ) {
                ...
                recyclerAdapter = new RecentListRecyclerAdapter( ReviewListActivity.jobLeadsList );
    ...
    private class settleButtonClickListener implements View.OnClickListener {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(view.getContext(), SettleCosts.class);
            view.getContext().startActivity(intent);
        }
    }
        ...
        myRef.push().setValue( jobLead )
                .addOnSuccessListener( new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        jobLeadsLists.add( jobLead );
                        recyclerAdapter.notifyItemInserted(jobLeadsLists.size() - 1);
